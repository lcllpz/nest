...
![image-20250211160505815](./assets/image-20250211160505815.png)
...
![image-20250211160928747](./assets/image-20250211160928747.png)

这种记录每个用户有什么权限的方式，其实也有专业的说法，叫做**ACL**(`Access Control List`)访问控制表

而RBAC是下面这个样子的：

![image-20250211161507798](./assets/image-20250211161507798.png)
...
![image-20250211164042486](./assets/image-20250211164042486.png)

针对上面这样的数据表设计，我们在代码的entity中，应该是下面这样的设计：

![image-20250211164717215](./assets/image-20250211164717215.png)
...
![image-20250211175021607](./assets/image-20250211175021607.png)
...
![image-20250212111729617](./assets/image-20250212111729617.png)
...
![image-20250212112420597](./assets/image-20250212112420597.png)
...
![image-20250212113129073](./assets/image-20250212113129073.png)
...
![image-20250212131519526](./assets/image-20250212131519526.png)
...
![image-20250212132802424](./assets/image-20250212132802424.png)

当登录之后，头信息中携带token信息

![image-20250212132737838](./assets/image-20250212132737838.png)
...
![image-20250212133604681](./assets/image-20250212133604681.png)

![image-20250212133648496](./assets/image-20250212133648496.png)

但是现在问题又出来了，设置为全局守卫之后，虽然方便，但是像login这样的登录，也被加入了守卫，像这样的路由，应该是可以直接访问的。

![image-20250212133819650](./assets/image-20250212133819650.png)
