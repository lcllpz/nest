...
[**TypeORM**](https://typeorm.io/docs/getting-started)([中文文档](https://www.typeorm.org/))是一个[ORM](https://en.wikipedia.org/wiki/Object-relational_mapping)，可以在 NodeJS、浏览器、Cordova、PhoneGap、Ionic、React Native、NativeScript、Expo 和 Electron 平台上运行，并且可以与 TypeScript 和 JavaScript（ES5、ES6、ES7、ES8）一起使用。
