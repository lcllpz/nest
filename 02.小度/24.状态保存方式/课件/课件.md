...
- **原理**：登录时，服务器生成一个唯一的 Session ID，并将其存储在服务器端。**该 Session ID 会存储在浏览器的 Cookie 中(自动存)**，用户每次请求时，服务器通过 Session ID 识别登录状态。
- **特点：**
...
![image-20250227154923819](./assets/image-20250227154923819.png)

![image-20250227154947222](./assets/image-20250227154947222.png)
